...
TEST_F(PenControllerTest, InitialState)
{
  ...
  const PenController controller(&line_series);
...
TEST_F(PenControllerTest, DefaultQtLineSeriesPen)
{
...
TEST_F(PenControllerTest, GraphItemInInitialState)
{
  ...
  PenController controller(&line_series);
...
TEST_F(PenControllerTest, GraphItemInChartInitialState)
{
  QtCharts::QChart chart;
  ...
  PenController controller(line_series_ptr);
