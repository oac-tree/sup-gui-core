...
TEST_F(AnyValueItemBuilderTests, FromStructWithSingleScalar)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(child->Data()), mvvm::constants::kLongIntVariantName);
}
...
TEST_F(AnyValueItemBuilderTests, FromNestedStruct)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(grandchild0->Data()), mvvm::constants::kLongIntVariantName);
...
TEST_F(AnyValueItemBuilderTests, FromTwoNestedStruct)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(grandchild1->Data()), mvvm::constants::kLongIntVariantName);
...
TEST_F(AnyValueItemBuilderTests, FromArrayOfIntegers)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(child0->Data()), mvvm::constants::kLongIntVariantName);
...
TEST_F(AnyValueItemBuilderTests, StructWithArrayOfIntegers)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(element0->Data()), mvvm::constants::kLongIntVariantName);
  ...
  EXPECT_EQ(mvvm::utils::TypeName(element1->Data()), mvvm::constants::kLongIntVariantName);
...
TEST_F(AnyValueItemBuilderTests, ArrayWithTwoStructureElements)
{
  ...
  EXPECT_EQ(mvvm::utils::TypeName(grandchild2->Data()), mvvm::constants::kLongIntVariantName);
  ...
  EXPECT_EQ(mvvm::utils::TypeName(grandchild3->Data()), mvvm::constants::kLongIntVariantName);
