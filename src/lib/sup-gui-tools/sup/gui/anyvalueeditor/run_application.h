...
#ifndef SUP_GUI_ANYVALUEEDITOR_MAIN_WINDOW_HELPER_H_
#define SUP_GUI_ANYVALUEEDITOR_MAIN_WINDOW_HELPER_H_
...
#endif  // SUP_GUI_ANYVALUEEDITOR_MAIN_WINDOW_HELPER_H_
