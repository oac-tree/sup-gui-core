...
#ifndef SUP_GUI_ANYVALUEEDITOR_ABSTRACT_ANYVALUE_EDITOR_H_
#define SUP_GUI_ANYVALUEEDITOR_ABSTRACT_ANYVALUE_EDITOR_H_
...
#endif  // SUP_GUI_ANYVALUEEDITOR_ABSTRACT_ANYVALUE_EDITOR_H_
