 ...
 *
 * @details For the moment controller only takes care of proper linking to external data. The most
 * of the work (adding/removal data points) is carried by underlying LineSeriesDataController.
 *
 * In the future it will be extended to control genericgraph  properties, like a pen, titles, etc.
 */
