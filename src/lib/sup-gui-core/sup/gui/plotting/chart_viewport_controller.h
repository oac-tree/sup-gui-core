...
#ifndef SUP_GUI_PLOTTING_CHART_VIEWPORT_CONTROLLER_H_
#define SUP_GUI_PLOTTING_CHART_VIEWPORT_CONTROLLER_H_
 ...
 */
class ChartViewportController : public mvvm::ItemListener<sup::gui::ChartViewportItem>
{
public:
  /**
