...
void LineSeriesController::Subscribe()
{
  ...
  Connect<mvvm::PropertyChangedEvent>(this, &LineSeriesController::OnPropertyChanged);
  Connect<mvvm::DataChangedEvent>(this, &LineSeriesController::OnDataChanged);
}
...
void LineSeriesController::OnPropertyChanged(const mvvm::PropertyChangedEvent &event)
{
  if (event.m_name == LineSeriesItem::kLink)
  {
