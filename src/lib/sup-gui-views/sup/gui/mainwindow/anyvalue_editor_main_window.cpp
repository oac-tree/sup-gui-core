...
{
  // it should be initilised first, since it creates global proxy actions used by others
  m_action_manager = new AnyValueEditorMainWindowActions(m_project.get(), m_settings.get(), this);
